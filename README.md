...
| File | Role |
|---|---|
| `SKILL.md` | Entry point: citation convention, precedence, the division-of-labour doctrine, order of operations + task routing table, 17 inline always-rules (incl. rule 7: scale and distance as relations, look values as deliberate controls), the mandatory per-prompt checklist with the Caption Spine lint, Render Slate contract with ID grammar, 5-step project workflow |
...
| `references/sources.md` | Registry of practitioner and vendor-thread protocols P17–P69 plus the official MiniMax guides [MM-off] (date, URL, sponsorship flag) behind the source tags |
| `LICENSE` | MIT |
